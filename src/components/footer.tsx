        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              >
                <svg className="w-4.5 h-4.5 text-slate-400 group-hover:text-primary-light" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link href="/#salas" className="hover:text-primary-light transition-colors">Buscar Salas</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><a href="mailto:contato@clinichub.com.br" className="hover:text-primary-light transition-colors">Contato</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link href="/#faq" className="hover:text-primary-light transition-colors">Perguntas Frequentes</Link></li>
              <li><Link href="#" className="hover:text-primary-light transition-colors">Termos de Uso</Link></li>
              <li><Link href="#" className="hover:text-primary-light transition-colors">Politica de Privacidade</Link></li>
              <li><a href="https://wa.me/5584999999999" target="_blank" rel="noopener noreferrer" className="hover:text-primary-light transition-colors flex items-center gap-1.5">
