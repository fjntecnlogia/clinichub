        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-10 gap-4">
          <div>
            ...
            <p className="text-slate-500 text-sm ml-[44px]">
              Escolha o pacote ideal para sua rotina. Preços com desconto e mais economia.
            </p>
          </div>
            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">Flexibilidade para encaixes rápidos.</p>
                </div>
              ...
              <a
                href="https://wa.me/5565993241115?text=Olá!%20Quero%20reservar%20um%20pacote%20de%20horas%20no%20MaciHub"
                target="_blank"
            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">Ótimo para rotina equilibrada.</p>
                </div>
                <div className="w-14 h-14 bg-primary-bg rounded-full flex items-center justify-center shrink-0 ml-3">
                  <svg className="w-7 h-7 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">O pacote com melhor custo-benefício.</p>
                </div>
              ...
              <a
                href="https://wa.me/5565993241115?text=Olá!%20Quero%20reservar%20o%20pacote%20de%203%20horas%20no%20MaciHub"
                target="_blank"
                rel="noopener noreferrer"
