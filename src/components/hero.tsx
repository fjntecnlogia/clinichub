        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary-bg border border-primary/20 rounded-full text-primary text-xs font-bold mb-8">
              ...
              N&ordm; 1 em Agendamento Odontológico
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-black text-dark leading-[1.1] tracking-tight mb-6">
              ...
              <br />
              <span className="text-primary">sem investir em clínica própria</span>
            </h1>

            <p className="text-lg text-slate-500 max-w-lg mb-8 leading-relaxed">
              Uma clínica completa, diversas salas disponíveis.
              Dentistas estão faturando{" "}
              <strong className="text-dark">mais de R$ 10.000,00/mês</strong>{" "}
              sem gastar com estrutura. Você paga apenas pelas horas que usar.
            </p>
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-sm text-dark">
                  <span className="font-black">Alta demanda!</span> Restam poucas horas disponíveis para hoje.
                </p>
              </div>
              <div className="flex items-center gap-3 ml-[52px]">
                <span className="text-lg">👥</span>
                <p className="text-sm text-slate-600">
                  +500 dentistas já atendidos e faturando <strong className="text-dark">mais de R$ 10.000,00/mês</strong> com o MaciHub.
                </p>
              </div>
            </div>
