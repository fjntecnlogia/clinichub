...
const categoriasDefault = ["Equipamentos", "Vestuario", "Descartaveis", "Mobiliario", "Tecnologia", "Higiene", "Outro"];
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-3 mb-6">
        ...
        <StatCard label="Receita Mes" value={`R$ ${receitaMes.toLocaleString("pt-BR", { minimumFractionDigits: 0 })}`} sub="mes atual" icon="📈" />
        <StatCard label="Ticket Medio" value={`R$ ${ticketMedio.toFixed(2)}`} sub={`${produtosDestaque} destaques`} icon="⭐" />
      </div>
              ...
              <div key={cat.id} className={`bg-white rounded-xl border-2 p-5 transition-shadow hover:shadow-md ${cat.ativo ? "border-slate-200" : "border-slate-100 opacity-60"}`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  {cat.id.startsWith("default-") ? (
                    <span className="text-[10px] text-slate-400 bg-slate-100 px-2 py-1 rounded">Padrao</span>
                  ) : (
                    <div className="flex items-center gap-1">
                      ...
                      {confirmDeleteCat === cat.id ? (
                        <div className="flex items-center gap-1">
                          ...
                          <button onClick={() => setConfirmDeleteCat(null)} className="px-2 py-1 bg-slate-200 text-slate-600 text-xs font-bold rounded hover:bg-slate-300">Nao</button>
                        </div>
                      ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => { setShowProdutoModal(false); setEditProduto(null); }}>
          <div className="bg-white rounded-2xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex gap-1 px-6 pt-4 bg-slate-50/50">
              {([
                { key: "geral" as const, label: "Informacoes Gerais", icon: "📝" },
            ...
            <form onSubmit={handleSaveProduto} className="overflow-y-auto flex-1 px-6 py-5">
              {produtoTab === "geral" && (
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-dark mb-1">Descricao Curta</label>
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-dark mb-1">Descricao Completa</label>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mt-1">Separadas por virgula, usadas para filtros</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-50 rounded-xl p-4 border border-slate-200 space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400">Visivel na loja para os clientes</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400">Aparece na secao de destaques da loja</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {produtoTab === "seo" && (
                <div className="space-y-4">
                  ...
                  <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                    <h4 className="font-semibold text-dark text-sm mb-2">Pre-visualizacao SEO</h4>
                    <div className="bg-white rounded-lg p-3 border border-slate-200">
                      ...
                      <p className="text-xs text-slate-500 mt-1 line-clamp-2">{editProduto?.descricao_curta || editProduto?.descricao || "Descricao do produto aparece aqui nos resultados de busca..."}</p>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 rounded-xl p-4">
                  ...
                  <div className="font-semibold text-dark">{activePedido.metodo_pagamento || "Nao informado"}</div>
              ...
              <div className="bg-slate-50 rounded-xl p-4">
                ...
                <div className="flex justify-between text-sm mb-1.5">
                  ...
                  <span>{Number(activePedido.frete) > 0 ? `R$ ${Number(activePedido.frete).toFixed(2)}` : "Gratis"}</span>
                </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-md mx-4 p-6" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSaveCategoria} className="space-y-4">
              ...
              <div>
                ...
                <textarea name="descricao" rows={2} defaultValue={editCategoria?.descricao ?? ""} placeholder="Descricao da categoria..." className="w-full px-3 py-2.5 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none resize-none" />
              </div>

              <div>
                <label className="block text-sm font-semibold text-dark mb-2">Icone</label>
