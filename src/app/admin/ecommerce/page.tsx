            ...
            <form onSubmit={handleSaveProduto} className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="relative w-20 h-20 rounded-xl bg-slate-100 border-2 border-dashed border-slate-300 flex items-center justify-center overflow-hidden shrink-0">
                    {fotoPreview ? (
                      <>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-400 mt-1.5">JPG, PNG ou WebP. Max 2MB.</p>
                  </div>
                </div>
              </div>
