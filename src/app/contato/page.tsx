            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <div className="space-y-5">
                  ...
                  <a href="https://www.instagram.com/imacieski" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 bg-pink-50 rounded-xl border border-pink-100 hover:border-pink-200 transition-colors group">
                    <div className="w-12 h-12 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 rounded-lg flex items-center justify-center shrink-0">
                      <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <h3 className="font-bold text-dark group-hover:text-pink-600 transition-colors">Instagram</h3>
                      <p className="text-sm text-slate-500">@imacieski</p>
                    </div>
                  </a>
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
              <div className="p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-100">
                ...
                <a
                  href="https://www.google.com/maps/search/?api=1&query=R.+das+D%C3%A1lias,+244+-+Jardim+Cuiab%C3%A1,+Cuiab%C3%A1+-+MT,+78088-715"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-white text-sm font-bold rounded-xl hover:bg-primary-dark transition-colors shrink-0"
                >
              ...
              <div className="w-full h-[400px] bg-slate-100">
                <iframe
                  src="https://maps.google.com/maps?q=R.+das+D%C3%A1lias,+244+-+Jardim+Cuiab%C3%A1,+Cuiab%C3%A1+-+MT,+78088-715&t=&z=16&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
