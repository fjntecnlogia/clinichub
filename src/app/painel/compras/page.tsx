...
const mockPedidos: Pedido[] = [
  {
    ...
    itens: [
      ...
      { nome: "Kit Curativos Estéreis", preco: 45.9, qty: 2 },
    ],
    subtotal: 281.7,
    frete: 0,
    total: 281.7,
    ...
    endereco: { rua: "Rua Exemplo, 123", cidade: "São Paulo", estado: "SP", cep: "01001-000" },
  ...
  {
    id: "demo-1014",
    itens: [{ nome: "Estetoscópio Littmann Classic III", preco: 849.9, qty: 1 }],
    subtotal: 849.9,
    frete: 0,
    total: 849.9,
    status: "Entregue",
...
const statusConfig: Record<string, { bg: string; text: string; icon: string }> = {
  ...
  "Em trânsito": { bg: "bg-indigo-50", text: "text-indigo-700", icon: "M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0" },
...
export default function MinhasCompras() {
  ...
  const tabs = ["Todos", "Pendente", "Em trânsito", "Entregue", "Cancelado"];
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          ...
          <div className="text-xl font-extrabold text-indigo-600">
            {pedidos.filter((p) => p.status === "Em trânsito" || p.status === "Pendente" || p.status === "Pago").length}
          </div>
        </div>
        <div className="bg-white rounded-xl border border-slate-200 p-4">
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="bg-slate-50 rounded-xl p-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-dark">
                    {Number(selected.frete) > 0 ? `R$ ${Number(selected.frete).toFixed(2).replace(".", ",")}` : "Grátis"}
                  </span>
                </div>
              ...
              {selected.endereco && (
                <div>
                  <h3 className="text-sm font-bold text-dark mb-2">Endereço de entrega</h3>
              ...
              {selected.notas && (
                <div>
                  <h3 className="text-sm font-bold text-dark mb-2">Observações</h3>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setTracking(null)}>
          <div className="bg-white rounded-2xl w-full max-w-md mx-4" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                <span className="text-sm text-slate-500 block mb-2">Código de rastreio</span>
              ...
              <div className="space-y-0">
                {[
                  ...
                  { label: "Em transporte", done: tracking.status === "Em trânsito" || tracking.status === "Entregue" },
