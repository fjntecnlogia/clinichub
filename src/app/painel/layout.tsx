      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col shrink-0">
        ...
        <div className="px-4 py-4 border-b border-slate-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-primary-bg text-primary flex items-center justify-center font-bold text-sm">AC</div>
            <div>
              <div className="text-sm font-semibold text-dark">Dra. Ana Costa</div>
              <div className="text-xs text-slate-400">Dermatologia</div>
            </div>
          </div>
        </div>
        ...
        <div className="px-3 pb-4 space-y-1">
          ...
          <Link href="/" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-slate-400 hover:bg-slate-50 hover:text-dark transition-colors">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
